...
class Bookdb:
    ...
    def insert(self, title, author, isbn):
        ...
        self.cursor.execute(sql,values) #print ("Row inserted")
        self.con.commit()
...
add_btn = Button(root, text="Add Book", bg="green", fg="white", font="helvetica 10 bold", command=add_book)
...
exit_btn = Button(root, text="Exit Application", bg="orange", fg= "white", font="helvetica 10 bold", command=root.destroy)
